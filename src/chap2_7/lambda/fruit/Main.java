...
public class Main {
    public static void main(String[] args) {
        ...
        List<Apple> yellowApples = filterAppleByColor(appleBasket, YELLOW);
        ...
        List<Apple> weight100AndRedApple = filterApples(appleBasket, apple -> apple.getWeight() >= 100 && apple.getColor() == RED);
        System.out.println("weight100AndRedApple = " + weight100AndRedApple);
        ...
        List<Apple> yelloAppleList = filter(appleBasket, a -> a.getColor() == YELLOW);
        System.out.println("yelloAppleList = " + yelloAppleList);
